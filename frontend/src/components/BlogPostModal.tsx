...
import { BlogPost, BlogPostFormData, UploadedImageData } from "@/services/blogService";
...
const BlogPostModal: React.FC<BlogPostModalProps> = ({ isOpen, onClose, post, onSubmit, isLoading = false }) => {
