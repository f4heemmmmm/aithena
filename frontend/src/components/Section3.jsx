...
/**
 * Carousel Items - Can be replaced with API call to retrieve:
 * Title
 * Image
 * Likes
 * Blog post
...
export default function Section3() {
    ...
    return (
        <section className = "section-3 py-16 bg-[#FAF0E6] min-h-screen">
            <div className = "container mx-auto px-4 gap-4 flex flex-col">
                ...
                <div className = "relative pb-16">
                    <Swiper
                        ...
                        navigation = {{ nextEl: ".swiper-custom-button-next", prevEl: ".swiper-custom-button-prev" }}
                        mousewheel = {true}
                    ...
                    >
                        {carouselItems.map((element) => (
                            <SwiperSlide key = {element.id}>
                                <div className = "relative h-100 rounded-[12px] overflow-hidden shadow-xl group cursor-pointer transform transition-transform duration-300 hover:-translate-y-1">
                                    <Image
                                        src = {element.image}
                                        alt = {element.title}
                                    ...
                                    <div className = "absolute bottom-0 left-0 right-0 p-5 z-20">
                                        ...
                                        <div className = "w-full h-px bg-white/60 my-3" />
