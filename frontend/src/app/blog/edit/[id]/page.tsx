...
export default function EditBlogPostPage() {
    ...
    useEffect(() => {
        ...
        if (foundPost) {
            ...
            setFormData({
                ...
                uploaded_image: foundPost.uploaded_image || "",
                uploaded_image_filename: foundPost.uploaded_image_filename || "",
                uploaded_image_content_type: foundPost.uploaded_image_content_type || "",
                is_published: foundPost.is_published || false,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setErrors({
                submit: error instanceof Error ? error.message : "Failed to update blog post"
            });
        } finally {
            setSubmitting(false);
        }
